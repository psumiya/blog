...
link:aws-lamda-latency-java-runtime.html[AWS Lambda Latency Metrics for Java Runtime]:: Latency Metrics for a couple of Java Runtime based AWS Lambdas

link:java-evolution.html[Java / JDK Release History]:: List of Java versions and the features released in the corresponding versions

link:aws-lambda-custom-runtime-with-java-and-gradle.html[Custom Java Runtime for AWS Lambda]:: Build a slimmed and enhanced JRE and use it as a custom runtime for AWS Lambda, using gradle and docker

link:when-not-to-use-kubernetes.html[When Not to Use Kubernetes]:: Some thoughts after having used Kubernetes in production.
...
* https://hachyderm.io/@sumiya[Mastodon - hachyderm.io/@sumiya, window=read-later]
* https://github.com/psumiya[Github - psumiya, window=read-later]
* https://www.linkedin.com/in/sumiya[LinkedIn - sumiya,window=read-later]

=== Professional

* Since 2021 @ Nike
* 2008 - 2020 @ various companies
